...
class EscalationCreated implements ProvidesAuditData, ShouldDispatchAfterCommit
{
    use Dispatchable;
    ...
    public function auditData(): AuditEventData
    {
        return new AuditEventData(
            ...
            payload: ['type' => $this->escalation->escalation_type?->apiValue(), 'reason' => $this->escalation->reason],
        );
    }
}
