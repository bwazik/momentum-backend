...
class TaskReturnedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'notification_type' => NotificationType::TaskReturned->value,
            'dedupe_key' => $this->dedupeKey,
            'title_ar' => __('notifications.task_returned.title', [], 'ar'),
            'title_en' => __('notifications.task_returned.title', [], 'en'),
            'body_ar' => __('notifications.task_returned.body', ['stage' => $this->stageNameAr, 'task' => $this->taskTitleAr], 'ar'),
            'body_en' => __('notifications.task_returned.body', ['stage' => $this->stageNameEn ?? $this->stageNameAr, 'task' => $this->taskTitleEn ?? $this->taskTitleAr], 'en'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('notifications.task_returned.subject', [], $locale))
            ->greeting(__('notifications.task_returned.title', [], $locale))
            ->line(__('notifications.task_returned.body', [
