...
class SlaWarningNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            'notification_type' => NotificationType::SlaWarning->value,
            'dedupe_key' => $this->dedupeKey,
            'title_ar' => __('notifications.sla_warning.title', [], 'ar'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('notifications.sla_warning.subject', [], $locale))
            ->greeting(__('notifications.sla_warning.title', [], $locale))
            ->line(__('notifications.sla_warning.body', [
