# Agent Instructions — Momentum Backend (Gov TMS)
...
Read relevant blueprint files when `docs/ai/` is insufficient or when resolving ambiguity.
...
- Database-per-tenant: no `tenant_id` in tenant DB tables
- No cross-module ORM joins
